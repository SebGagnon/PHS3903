...
gamma_max = 2000  # valeur maximale de gamma sur les bords finaux
gamma = PML(nx, ny, epaisseur_pml, puissance=4, gamma_max=gamma_max)  
...
pas_sauvegarde = max(1, nt // 9181)  # intervalle entre deux sauvegardes d'image
