...
def objectif_pml_moyen_optuna(trial):
    ...
    gamma_max_local = trial.suggest_float("gamma_max", 1.0, 10000.0, log=True)
    puissance_pml_local = trial.suggest_float("puissance_pml", 0.01, 100.0)
